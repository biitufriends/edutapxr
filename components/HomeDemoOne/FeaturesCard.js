                    ...
                    <div className="row justify-content-center">
                        <div className="col-lg-3 col-md-6">
                            <div className="single-features">
                                    ...
                                    <a><img src="/images/features/edutaps-login.png" alt="image" /></a>
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="single-features">
                                <Link href="/services-details">
                                    <a><img src="/images/features/edutaps-download.png" alt="image" /></a>
                                </Link>

                                <h3>
                                    <Link href="/services-details">
                                        <a>Dowmnload Resources</a>
                                    </Link>
                                </h3>
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="single-features">
                                <Link href="/services-details">
                                    <a><img src="/images/features/edutaps-course.png" alt="image" /></a>
                                </Link>

                                <h3>
                                    <Link href="/services-details">
                                        <a>Select Subject Chapter </a>
                                    </Link>
                                </h3>
                                <p>Best Strategic planning dolor sit amet, consectetur adipiscing elit. Scelerisque amet odio velit, eu, auctor. Aliquet nam elit nulla eget sodales dui pulvinar.</p>
                        ...
                        <div className="col-lg-3 col-md-6">
                            <div className="single-features">
                                <Link href="/services-details">
                                    <a><img src="/images/features/edutaps-armode.png" alt="image" /></a>
                                </Link>

                                <h3>
                                    <Link href="/services-details">
                                        <a>View in Augmentrd Reality</a>
                                    </Link>
                                </h3>
                                <p>Best Strategic planning dolor sit amet, consectetur adipiscing elit. Scelerisque amet odio velit, eu, auctor. Aliquet nam elit nulla eget sodales dui pulvinar.</p>
