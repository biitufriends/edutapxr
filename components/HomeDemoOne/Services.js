            ...
            <div className="services-area pt-100 pb-70">
                <div className="container">
                    <div className="section-title">
                        <h2>Enjoy Next Level Learning Experience</h2>
                        <p>Enjoy highly engaging and interactive way of impactful and once in a life-time learning experience</p>
                    </div>
                    ...
                    <div className="row justify-content-center">
                        <div className="col-lg-4 col-md-6">
                            <div className="single-services">
                                ...
                                <p>Self Learning App with excellent customer service with quick response to all inquiries.</p>
