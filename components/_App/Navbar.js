                                ...
                                <ul className="navbar-nav m-auto">
                                    ...
                                    <li className="nav-item">
                                                <Link href="/terms-of-service" activeClassName="active">
                                                    <a onClick={toggleNavbar} className="nav-link">Terms and Condition</a>
                                                </Link>
                                     </li>
                    ...
                    <div className="modal-content">
                        ...
                        <div className="modal-body">
                            ...
                            <ul className="sidebar-social-list">
                                <li>
                                    <a href="https://www.facebook.com/edutapin" target="_blank">
                                ...
                                <li>
                                    <a href="https://linkedin.com/company/edutaps" target="_blank">
