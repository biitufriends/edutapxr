                    ...
                    <div className="row justify-content-center">
                        <div className="col-lg-8 col-md-12">
                            <div className="privacy-policy-content">
                                ...
                                <img src="/images/edutaps-privacy-policy.png" alt="image" />

                                <p><i>This Privacy Policy was last updated on September 1, 2021.</i></p>
                                <p><i>Welcome! to Edutaps: a dedicated online education platform for immersive learning. Edutaps brings school education content to a three-dimensional (3D) Augmented Reality (AR) learning app. Using Edutap, students learn their subjects with simulation and guided voice over.
...
Our “Platform” is made up of Edutap, other sites, apps, products, and services on which this Privacy Policy is posted and that are Edutaps-branded or operated by the xrlearn, including our plug-ins, embedded content made available on other sites, and browser extensions.
...
The terms “we,” “us,” or “our” refer to xrlearn, an Indian private limited company. By “you,” we are referring to visitors and users of any part of our Platform.</i></p>
                                ...
                                <p>We collect information and content that you submit to our Platform, including comments, reviews, searches, other types of content provided in our Edutaps.</p>
                                ...
                                <p>For your convenience, we and our payment processors will store information about the payment method you use in connection with the Platform. Note that while our payment processors may store your complete credit card number, Edutaps does not. You may remove or change your payment method on Edutaps through your settings.</p>

                                <p>If you make purchases on Edutaps as a visitor and subsequently create an account, for your reference, we will make information available to you about any prior purchases completed using the email address for your account.</p>
                                ...
                                <p>One of the main purposes of having a Edutaps account is to learn with immersive content. If you are a school or institution on Edutaps, we may also display the following information in order to help visitors and users: your last visit to Edutaps, aggregated information on our Platform about your Platform activity (e.g.reviews), and information that is publicly available from third parties. We have policies that place restrictions on Platform visitors’ and users’ use of information and content you choose to make available publicly through the Platform.</p>
                                <h3>Schools and Other Educational institution on our Platform</h3>

                                <p>Edutaps Platform may share your information to students about your organization and display your reviews. Any information collected through surveys are used by the platform to show relevant content.</p>
                                ...
                                <p>An essential part of our services that you sign up for when you create an account on our Platform is to receive communications from the Edutaps group through email , mobile number and our Platform. If you use our mobile app or provide us with your cell phone number, these communications also include text messages and push notifications.</p>
...
<h2>Contact Us</h2>
<p>Edutaps is responsible for the use of your personal information. If you have questions or comments about this Privacy Policy (including about the manner in which we or our service providers treat your personal information), you may contact us in the following ways:</p>

<li>Email us at support@edutaps.com</li>
